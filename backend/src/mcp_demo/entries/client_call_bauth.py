...
python src/mcp_demo/entries/client_call_bauth.py --username=your_username --password=your_password
"""
...
async def _run_client(
    *,
    ...
    client: Client = Client(
        ...
        transport=get_mcp_config_bauth(  # type: ignore
            host=host,
